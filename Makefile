...
SRC_FILES += src/netkit.c src/config.c
SRC_FILES += src/cmd/handlers/file.c src/cmd/handlers/socket.c src/cmd/handlers/task.c
...
SRC_FILES += src/sys/crypto.c src/sys/file.c src/sys/lock.c src/sys/mem.c src/sys/socket.c src/sys/symbol.c src/sys/task.c
