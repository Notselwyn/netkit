 ...
 */ 
static inline int io_process(pipeline_func_t *pipeline_funcs, u8 *req_buf, size_t req_buflen, u8 **res_buf, size_t *res_buflen)
{
    NETKIT_LOG("[*] starting IO transformation pipeline...\n");
    return pipeline_process(pipeline_funcs, req_buf, req_buflen, res_buf, res_buflen);
}
